...
public class BookService {
    ...
    public PageResponse<BookResponse> findByAllBooks(int page, int size, Authentication connectedUser) {
        User user = ((User) connectedUser.getPrincipal());
    ...
    public PageResponse<BookResponse> findByAllBooksByOwner(int page, int size, Authentication connectedUser) {
        User user = ((User) connectedUser.getPrincipal());
        Pageable pageable = PageRequest.of(page, size, Sort.by("createdDate").descending());
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = BookTransactionHistory.builder()
                .user(user).book(book).returned(false).returnApproved(false).build();
